...
public class OaEmp implements Serializable {
	...
	//bi-directional one-to-one association to OaPassword
	...
	public OaTrainplan addOaTrainplans1(OaTrainplan oaTrainplans1) {
		getOaTrainplans1().add(oaTrainplans1);
		oaTrainplans1.setOaEmp(this);

		return oaTrainplans1;
	}

	public OaTrainplan removeOaTrainplans1(OaTrainplan oaTrainplans1) {
		getOaTrainplans1().remove(oaTrainplans1);
		oaTrainplans1.setOaEmp(null);
